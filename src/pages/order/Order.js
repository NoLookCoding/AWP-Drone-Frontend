...
const Order = () => {
  ...
  const fetchDrones = (params) => {
    ...
    api
      ...
      .catch(error => {
        console.error('주문 정보를 가져오는 중 에러가 발생했습니다:', error);
        setIsLoading(false);
      });
  };
  ...
  const fetchAllDrones = (params) => {
    ...
    api
      ...
      .catch(error => {
        console.error('전체 주문 정보를 가져오는 중 에러가 발생했습니다:', error);
      });
  };
          ...
          <div className="order-content-noti">
            <ul>
              <li>
                <span>주문 완료</span>
                <p>
                  주문 신청 및 결제가 완료된 상태입니다. 주문정보를 수정/취소하시려면 <br/>
              ...
              <li>
                <span>배송 준비중</span>
                <p>
                  배송 준비중 단계에서는 상품이 물류센터 內 이동을 시작하였기 때문에<br/>주문정보 수정/취소가 불가합니다.<br/>
              ...
              <li>
                <span>배송중</span>
                <p>
                  주문하신 상품 전체(또는 일부)의 배송이 시작된 상태입니다. <br/>배송상세 버튼을 클릭하시면 상세 진행 현황을
                  확인 하실수 있습니다.
                </p>
              </li>
              <li>
              ...
              <li>
                <span>취소</span>
                <p>
                  주문하신 상품이 취소된 상태입니다. 주문정보의 변경 및 배송조회가 불가능하며,<br/> 환불절차가 진행됩니다. 고객센터를 통해 문의하시기 바랍니다.
                </p>
              </li>
            </ul>
          </div>
