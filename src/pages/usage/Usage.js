      ...
      <div className="Usage">
        <div className='container'>
          <div className="Usage-content-frame">
            ...
            <button id="button" style={{ visibility: isButtonVisible ? 'visible' : 'hidden' }} onClick={ClickDroneBuyButton}>구매하기</button>
          </div>
          <div className='Usage-picture-frame'>
            {images.map(image => (
              <img
                ...
                src={image.src}
                alt={image.alt}
                style={{ width: 150, height: 150, margin: 20, cursor: 'pointer' }}
                onClick={() => {
